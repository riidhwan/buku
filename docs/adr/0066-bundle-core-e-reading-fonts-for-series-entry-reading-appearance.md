...
Bundling keeps Series Entry Reading offline and deterministic on Android WebView, while the `other-core` package avoids choosing Kobo renderer-specific assets for a non-Kobo runtime. The original scope deliberately excluded Explore Reading Mode until a shared reader appearance model was justified; ADR 0069 later shares Reading Appearance across Reading Mode and Series Entry Reading.
